...
//=========  (Mon Mar 16 17:02:09 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9309328,1.0375,6.230089);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.728818);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.185314);
   h_gammaD_1_cT->SetBinContent(2,1.162696);
   h_gammaD_1_cT->SetBinContent(3,0.4349331);
   h_gammaD_1_cT->SetBinContent(4,0.1582147);
   h_gammaD_1_cT->SetBinContent(5,0.05884278);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.182677);
   h_gammaD_2_cT->SetBinContent(2,1.17399);
   h_gammaD_2_cT->SetBinContent(3,0.4298754);
   h_gammaD_2_cT->SetBinContent(4,0.1566788);
   h_gammaD_2_cT->SetBinContent(5,0.05677956);
   h_gammaD_2_cT->SetBinContent(6,0.0358177);
