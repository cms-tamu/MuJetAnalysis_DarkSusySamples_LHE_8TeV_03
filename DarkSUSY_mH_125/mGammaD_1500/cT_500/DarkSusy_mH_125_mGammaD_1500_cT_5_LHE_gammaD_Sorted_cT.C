...
//=========  (Mon Mar 16 17:10:23 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03719034,25.9375,0.2488892);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2288636);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1275823);
   h_gammaD_1_cT->SetBinContent(2,0.04663638);
   h_gammaD_1_cT->SetBinContent(3,0.01735366);
   h_gammaD_1_cT->SetBinContent(4,0.006217512);
   h_gammaD_1_cT->SetBinContent(5,0.002210112);
   h_gammaD_1_cT->SetBinContent(6,0.001374397);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1271465);
   h_gammaD_2_cT->SetBinContent(2,0.04671112);
   h_gammaD_2_cT->SetBinContent(3,0.01726472);
   h_gammaD_2_cT->SetBinContent(4,0.006562657);
   h_gammaD_2_cT->SetBinContent(5,0.002315048);
   h_gammaD_2_cT->SetBinContent(6,0.001305989);
