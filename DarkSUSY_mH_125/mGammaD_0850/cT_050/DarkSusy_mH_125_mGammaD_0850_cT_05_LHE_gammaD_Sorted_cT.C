...
//=========  (Mon Mar 16 17:01:17 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.3726328,2.59375,2.493773);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.293125);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.269849);
   h_gammaD_1_cT->SetBinContent(2,0.47076);
   h_gammaD_1_cT->SetBinContent(3,0.1727848);
   h_gammaD_1_cT->SetBinContent(4,0.06345092);
   h_gammaD_1_cT->SetBinContent(5,0.02315543);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.273958);
   h_gammaD_2_cT->SetBinContent(2,0.4641522);
   h_gammaD_2_cT->SetBinContent(3,0.173796);
   h_gammaD_2_cT->SetBinContent(4,0.06403141);
   h_gammaD_2_cT->SetBinContent(5,0.02406212);
   h_gammaD_2_cT->SetBinContent(6,0.01354123);
