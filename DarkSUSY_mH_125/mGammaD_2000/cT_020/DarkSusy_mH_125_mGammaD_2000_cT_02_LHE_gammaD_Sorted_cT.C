...
//=========  (Mon Mar 16 17:11:43 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9331309,1.0375,6.244799);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.742344);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.170019);
   h_gammaD_1_cT->SetBinContent(2,1.182306);
   h_gammaD_1_cT->SetBinContent(3,0.4349933);
   h_gammaD_1_cT->SetBinContent(4,0.155593);
   h_gammaD_1_cT->SetBinContent(5,0.05708855);
   h_gammaD_1_cT->SetBinContent(6,0.03531056);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.190191);
   h_gammaD_2_cT->SetBinContent(2,1.165701);
   h_gammaD_2_cT->SetBinContent(3,0.4235079);
   h_gammaD_2_cT->SetBinContent(4,0.1619239);
   h_gammaD_2_cT->SetBinContent(5,0.0586754);
   h_gammaD_2_cT->SetBinContent(6,0.03645178);
