...
//=========  (Mon Mar 16 17:10:24 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9313059,1.0375,6.232586);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.731113);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.177427);
   h_gammaD_1_cT->SetBinContent(2,1.179075);
   h_gammaD_1_cT->SetBinContent(3,0.427531);
   h_gammaD_1_cT->SetBinContent(4,0.1578557);
   h_gammaD_1_cT->SetBinContent(5,0.05811102);
   h_gammaD_1_cT->SetBinContent(6,0.03119379);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.183952);
   h_gammaD_2_cT->SetBinContent(2,1.168183);
   h_gammaD_2_cT->SetBinContent(3,0.4264985);
   h_gammaD_2_cT->SetBinContent(4,0.1625326);
   h_gammaD_2_cT->SetBinContent(5,0.05883389);
   h_gammaD_2_cT->SetBinContent(6,0.03385308);
