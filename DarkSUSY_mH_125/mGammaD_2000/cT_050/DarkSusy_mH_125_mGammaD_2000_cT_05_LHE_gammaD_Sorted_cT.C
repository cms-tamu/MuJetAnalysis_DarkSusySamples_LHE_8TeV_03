...
//=========  (Mon Mar 16 17:11:39 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.3717716,2.59375,2.48801);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.287825);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.270944);
   h_gammaD_1_cT->SetBinContent(2,0.4671483);
   h_gammaD_1_cT->SetBinContent(3,0.1738999);
   h_gammaD_1_cT->SetBinContent(4,0.06356359);
   h_gammaD_1_cT->SetBinContent(5,0.02444366);
   h_gammaD_1_cT->SetBinContent(6,0.01387071);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.271014);
   h_gammaD_2_cT->SetBinContent(2,0.4686285);
   h_gammaD_2_cT->SetBinContent(3,0.1729175);
   h_gammaD_2_cT->SetBinContent(4,0.06429048);
   h_gammaD_2_cT->SetBinContent(5,0.0231496);
   h_gammaD_2_cT->SetBinContent(6,0.01298391);
