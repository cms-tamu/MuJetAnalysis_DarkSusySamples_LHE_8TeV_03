...
//=========  (Mon Mar 16 17:02:12 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.3715003,2.59375,2.486195);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.286156);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.270677);
   h_gammaD_1_cT->SetBinContent(2,0.4691311);
   h_gammaD_1_cT->SetBinContent(3,0.172916);
   h_gammaD_1_cT->SetBinContent(4,0.0641166);
   h_gammaD_1_cT->SetBinContent(5,0.02315951);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.270087);
   h_gammaD_2_cT->SetBinContent(2,0.471028);
   h_gammaD_2_cT->SetBinContent(3,0.168823);
   h_gammaD_2_cT->SetBinContent(4,0.0651178);
   h_gammaD_2_cT->SetBinContent(5,0.02494462);
   h_gammaD_2_cT->SetBinContent(6,0.01366794);
