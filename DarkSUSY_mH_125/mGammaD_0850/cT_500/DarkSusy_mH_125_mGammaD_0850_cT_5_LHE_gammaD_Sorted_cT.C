...
//=========  (Mon Mar 16 17:01:17 2015) by ROOT version5.34/18
   ...
   cnv->Range(-5.3125,-0.03742848,25.9375,0.2504829);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2303291);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1272507);
   h_gammaD_1_cT->SetBinContent(2,0.04655368);
   h_gammaD_1_cT->SetBinContent(3,0.01713717);
   h_gammaD_1_cT->SetBinContent(4,0.006691178);
   h_gammaD_1_cT->SetBinContent(5,0.002367222);
   h_gammaD_1_cT->SetBinContent(6,0.001463144);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1279606);
   h_gammaD_2_cT->SetBinContent(2,0.04615675);
   h_gammaD_2_cT->SetBinContent(3,0.01723326);
   h_gammaD_2_cT->SetBinContent(4,0.006341015);
   h_gammaD_2_cT->SetBinContent(5,0.002308341);
   h_gammaD_2_cT->SetBinContent(6,0.001379467);
