...
//=========  (Mon Mar 16 17:11:40 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.09314468,10.375,0.6233529);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.573198);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3168564);
   h_gammaD_1_cT->SetBinContent(2,0.1178233);
   h_gammaD_1_cT->SetBinContent(3,0.04312928);
   h_gammaD_1_cT->SetBinContent(4,0.01627342);
   h_gammaD_1_cT->SetBinContent(5,0.005917607);
   h_gammaD_1_cT->SetBinContent(6,0.003619813);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3184434);
   h_gammaD_2_cT->SetBinContent(2,0.1170194);
   h_gammaD_2_cT->SetBinContent(3,0.04297657);
   h_gammaD_2_cT->SetBinContent(4,0.01552998);
   h_gammaD_2_cT->SetBinContent(5,0.006030695);
   h_gammaD_2_cT->SetBinContent(6,0.003600791);
