...
//=========  (Mon Mar 16 17:01:12 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9325139,1.0375,6.240671);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.738548);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.187977);
   h_gammaD_1_cT->SetBinContent(2,1.168615);
   h_gammaD_1_cT->SetBinContent(3,0.428708);
   h_gammaD_1_cT->SetBinContent(4,0.1549388);
   h_gammaD_1_cT->SetBinContent(5,0.05976121);
   h_gammaD_1_cT->SetBinContent(6,0.03245977);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.188082);
   h_gammaD_2_cT->SetBinContent(2,1.16889);
   h_gammaD_2_cT->SetBinContent(3,0.4249308);
   h_gammaD_2_cT->SetBinContent(4,0.1593884);
   h_gammaD_2_cT->SetBinContent(5,0.05870878);
   h_gammaD_2_cT->SetBinContent(6,0.03391644);
