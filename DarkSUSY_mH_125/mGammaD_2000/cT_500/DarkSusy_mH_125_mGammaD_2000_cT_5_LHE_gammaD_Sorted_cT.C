...
//=========  (Mon Mar 16 17:11:40 2015) by ROOT version5.34/18
   ...
   cnv->Range(-5.3125,-0.03723631,25.9375,0.2491968);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2291465);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1273621);
   h_gammaD_1_cT->SetBinContent(2,0.04679764);
   h_gammaD_1_cT->SetBinContent(3,0.01718656);
   h_gammaD_1_cT->SetBinContent(4,0.006384585);
   h_gammaD_1_cT->SetBinContent(5,0.002269068);
   h_gammaD_1_cT->SetBinContent(6,0.00124522);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1273036);
   h_gammaD_2_cT->SetBinContent(2,0.04692095);
   h_gammaD_2_cT->SetBinContent(3,0.01719537);
   h_gammaD_2_cT->SetBinContent(4,0.006231118);
   h_gammaD_2_cT->SetBinContent(5,0.002348943);
   h_gammaD_2_cT->SetBinContent(6,0.001407351);
