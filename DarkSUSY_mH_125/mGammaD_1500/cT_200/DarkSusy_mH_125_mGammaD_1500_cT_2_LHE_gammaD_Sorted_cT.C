...
//=========  (Mon Mar 16 17:10:32 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.09321962,10.375,0.6238544);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5736592);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3185661);
   h_gammaD_1_cT->SetBinContent(2,0.1172112);
   h_gammaD_1_cT->SetBinContent(3,0.04267886);
   h_gammaD_1_cT->SetBinContent(4,0.01566884);
   h_gammaD_1_cT->SetBinContent(5,0.005875027);
   h_gammaD_1_cT->SetBinContent(6,0.003207991);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3186996);
   h_gammaD_2_cT->SetBinContent(2,0.1170659);
   h_gammaD_2_cT->SetBinContent(3,0.04252306);
   h_gammaD_2_cT->SetBinContent(4,0.01590918);
   h_gammaD_2_cT->SetBinContent(5,0.005802318);
   h_gammaD_2_cT->SetBinContent(6,0.003448667);
