...
//=========  (Mon Mar 16 17:02:22 2015) by ROOT version5.34/18
   ...
   cnv->Range(-5.3125,-0.03715821,25.9375,0.2486742);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2286659);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.127221);
   h_gammaD_1_cT->SetBinContent(2,0.04703485);
   h_gammaD_1_cT->SetBinContent(3,0.01719462);
   h_gammaD_1_cT->SetBinContent(4,0.006297647);
   h_gammaD_1_cT->SetBinContent(5,0.002251856);
   h_gammaD_1_cT->SetBinContent(6,0.001280664);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1270366);
   h_gammaD_2_cT->SetBinContent(2,0.04690827);
   h_gammaD_2_cT->SetBinContent(3,0.01740783);
   h_gammaD_2_cT->SetBinContent(4,0.006243865);
   h_gammaD_2_cT->SetBinContent(5,0.002403423);
   h_gammaD_2_cT->SetBinContent(6,0.00133132);
